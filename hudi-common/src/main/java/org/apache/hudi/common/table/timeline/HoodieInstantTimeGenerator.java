...
public class HoodieInstantTimeGenerator {
   ...
   * Ensures each instant time is atleast 1 second apart since we create instant
   * times at second granularity
   *
   * @param milliseconds Milliseconds to add to current time while generating the
   *                     new instant time
   */
